...
export const qualityPhilosophyPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "",
      "Over time, this erodes trust in QA as a discipline. QA stops being a partner in risk management and becomes a formality in the delivery checklist.",
      "",
  ...
  },
  {
    ...
    content: [
      ...
      "- The cycle repeats, continuously improving coverage",
      "",
      "The key shift is this:",
      "automation runs in the testbed, but learning happens in production.",
      "",
      "## 1. Telemetry as the Source of Truth",
      ...
      "",
      "Telemetry is not feedback on tests — it is feedback on the product itself.",
      "",
      ...
      "- De-prioritise low-value, synthetic tests",
      "",
      "Tests are no longer speculative.",
      "They are user-behaviour-driven.",
      "",
      "This results in:",
      "",
      "- Fewer tests",
      ...
      "",
      "Automation does not learn — it enforces what we have learned.",
      "",
      ...
      "",
      "That is not faster testing.",
      "That is quality engineering driven by reality."
    ],
    image: '/images/automation-telemetry.jpeg',
