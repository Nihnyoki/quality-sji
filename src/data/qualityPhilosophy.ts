...
export const qualityPhilosophyPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "Contrain the critical inputs to a valid range, and use a critiria based input selection method for the tests input parameters. This approach enables the non-critical inputs to vary dynamically.",
